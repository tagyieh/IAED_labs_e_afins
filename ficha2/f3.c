...
float valorTotal (Telefone t[], int n)
{
  ...
  for (c=0;c<n;c++)
  {
    ...
    {
      ch=t[c].ut_mensal[k];
      total+=(ch.duracao/60)*t[c].preco_minuto;
    }
  }
  return total;
}
...
int main()
{
  ...
  Telefone t[2] = {{"967849123","ABC",1.1,{{{21,01,2022}, 120, "967849123"}}},
                {"967849123","ABC",2.5,{{{21,01,2022}, 120, "967849123"},{{21,01,2022}, 140, "967849123"}}}};
  printf("%f\n",valorTotal(t,2));
  /*output correto = 14.7*/
  return 0;
}
